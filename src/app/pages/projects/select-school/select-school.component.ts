...
import { GetSchoolUsersCompact, SchoolUserState } from 'src/app/store/user/school-user.action';
...
export class SelectSchoolComponent implements OnInit, OnChanges {
  @Select(SchoolUserState.schoolUsersCompact) schoolUsers$: Observable<SchoolUser[]>;
  ...
  constructor(private store: Store) {
    store.dispatch(new GetSchoolUsersCompact());
  }
