...
export class PDFReport implements OnInit {
  ...
  async onGenerate(report: DiagnosticReport) {
        ...
        table: {
          body: [
            ...
            [
              ...
              {
                text:
                  report.yearSummary.math && report.yearSummary.math.totalResultAverage !== undefined
            ...
            [
              ...
              {
                text: `${
                  report.yearSummary.math && report.yearSummary.math.improvementPercentageAverage !==
                  undefined
    ...
    // -- Generate document --
    let window = pdfMake.createPdf(finalReport);
    window.open();
  }
